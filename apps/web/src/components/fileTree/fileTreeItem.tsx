...
import { ChevronDown, ChevronRight, File as FileIcon, FilePlus, Folder, FolderPlus } from 'lucide-react';
          ...
          >
            ...
            {item.type === 'directory' && (
              <div className="hidden gap-1 group-hover:flex ">
                <button
                  className="p-1 bg-gray-50 dark:bg-black rounded text-blue-500 hover:text-blue-700"
                  onClick={(e) => {
                    e.stopPropagation();
